...
public static class ShopPageSwitcher
{
        ...
        string shopName, NPC npc)
    {
        ...
        for (var i = 0; i < events.Length; ++i)
        {
            ...
            events[i] += delegate
            {
                ...
                if (newIndex >= 0 && newIndex < shopPageContext.TotalPages) shopPageContext.CurPageIndex = newIndex;
    ...
    private static void SetShopPage(ShopPageContext ctx)
    {
        ...
        for (var i = copyCount; i < Chest.maxItems; ++i) chest.item[i] = new Item(0);
